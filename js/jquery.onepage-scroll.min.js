! function (e) {
    ...
    e.fn.onepage_scroll = function (n) {
        ...
        function u(e, t) {
            var n = t,
                s = (new Date).getTime();
            if (s - lastAnimation < quietPeriod + r.animationTime) {
                e.preventDefault();
                return
            }
            if (n < 0) {
        ...
        e.fn.transformPage = function (t, n, r) {
            ...
            e(this).css({
                ...
                "-webkit-transition": "-webkit-transform " + t.animationTime + "ms " + t.easing,
                "-moz-transform": "translate3d(0, " + n + "%, 0)",
                "-moz-transition": "-moz-transform " + t.animationTime + "ms " + t.easing,
                "-ms-transform": "translate3d(0, " + n + "%, 0)",
                "-ms-transition": "-ms-transform " + t.animationTime + "ms " + t.easing,
                transform: "translate3d(0, " + n + "%, 0)",
                transition: "transform " + t.animationTime + "ms " + t.easing
            });
        ...
        e.each(s, function (t) {
            e(this).addClass("ops-section").attr("data-index", t + 1);
            topPos = topPos + 100;
            if (r.pagination == true) {
        ...
        if (r.pagination == true) {
            e("<ul class='onepage-pagination'>" + paginationList + "</ul>").prependTo("body");
